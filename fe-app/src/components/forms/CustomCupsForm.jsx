  ...
  return (
    <section className="flex justify-center items-center min-h-screen border border-solid border-black">
      <div className="bg-white bg-opacity-10 p-10 m-20 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center">Order Your Custom Cup</h2>
        <form className="space-y-4">
          {/* Cup Size Field */}
          <div>
            <label htmlFor="size" className="block text-sm font-medium text-gray-700">Cup Size</label>
            <select
              id="size"
          ...
          {/* Cup Color Field */}
          <div>
            <label htmlFor="color" className="block text-sm font-medium text-gray-700">Cup Color</label>
            <input
              type="color"
              id="color"
